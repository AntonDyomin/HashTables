...
namespace HashTable
{
    class Program
    {
        ...
        private static void ThreeElemTest() //Добавление трёх элементов, поиск трёх элементов
        {
            ...
            if (j == 3)
                Console.WriteLine("Программа на добавление и поиск трёх элементов работает корректно.");
            else
        ...
        private static void RepeatKeyTest() //Добавление одного и того же ключа дважды с разными значениями сохраняет последнее добавленное значение
        {
            ...
            hashTable.PutPair("key10", "value98");
            hashTable.PutPair("key10", "value99");
            if (hashTable.GetValueByKey("key10").Equals("value99"))
                Console.WriteLine("Программа на добавление одного и того же ключа дважды работает корректно.");
            else
        ...
        private static void AddAndSearchElemTest()//Добавление 10000 элементов в структуру и поиск одного из них
        {
            ...
            if (hashTable.GetValueByKey("key1348").Equals("value1345"))
                Console.WriteLine("Программа на добавление 10000 элементов в структуру и поиск одного из них работает корректно.");
            else
        ...
        private static void SearchAndAddElemAndKeysTest()//Добавление 10000 элементов в структуру и поиск 1000 недобавленных ключей, поиск которых должен вернуть null
        {
            ...
            if (j == 1000)
                Console.WriteLine("программа на добавление 10000 элементов в структуру и поиск 1000 недобавленных ключей работает корректно.");
            else
